...
// We define an object trhat contains the overlays
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  // This function determinse the color of the circle based on the magnitude of the earthquakes
  ...
  legend.onAdd = function() { // we will add a lengend to the map with onAdd
    let div = L.DomUtil.create("div", "info legend"); // the legend will be added to a div element on the index.html file using DomUtil utility function
    ...
    // the for llop will add the color choices from our colors array as a small box for the color of earthquakes 
    // and place the text of the magnitude range next to the box
// Looping through our intervals to generate a label with a colored square for each interval.
// ******** Check Module 13.6.5 for explanation!*********
