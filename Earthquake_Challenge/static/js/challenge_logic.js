...
function styleInfoMajorE(feature) {
  return {
    opacity: 1,
    fillOpacity: 1,
    fillColor: getColorMajorE(feature.properties.mag),
    color: "#000000",
    radius: getRadiusMajorE(feature.properties.mag),
    stroke: true,
    weight: 0.5
  };
}
...
function getColorMajorE(magnitude) {
...
function getRadiusMajorE(magnitude) {
  if (magnitude === 0) {
    return 1;
  }
  return magnitude * 4;
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  L.geoJson(data, {style:myTectonicStyle}).addTo(tectonicPlate);
